...
import { useBlogPostBySlug, useBlogPosts } from "@/services/blogService";
...
export default function BlogDetailPage({
  ...
  const { data: post, isLoading, isError } = useBlogPostBySlug(params.slug);
    ...
    return {
      ...
      author: {
        name:
          ...
          "Admin",
        image: post.author.imageUrl || undefined,
      ...
      .map((p) => ({
        ...
        author: {
          name:
            ...
            "Admin",
          image: p.author.imageUrl || undefined,
        },
  ...
  const currentLikeCount = (article.likeCount || 0) + likeDelta;
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center py-12 bg-muted rounded-2xl border-2 border-dashed border-border">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Connect with the database to enable comments.
              </p>
            </div>
          </div>
        </div>
