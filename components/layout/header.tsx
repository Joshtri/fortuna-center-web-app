...
export function Header({
  ...
  useEffect(() => {
    ...
    // Check localStorage on mount to ensure synchronization
    // This is a safety check in case ThemeInit didn't run or completed before observer attached
    // We strictly invoke it only if mismatch to minimize re-renders,
    // but better to just let observer handle subsequent changes.
    // However, to ensure correct initial visual state if hydration mismatch occurs:
